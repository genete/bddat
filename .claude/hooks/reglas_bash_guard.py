...
REGLAS = [
    ...
    (r'\b(for|while|until)\b[\s\S]*?\bdo\b[\s\S]*?\bdone\b',
     'bucle for/while/until en una sola línea (simple_expansion no analizable estáticamente)',
     'Write el bucle completo a docs_prueba/temp/script.sh y ejecutar bash docs_prueba/temp/script.sh; o, mejor, evitar el bucle y lanzar varias llamadas Bash/tool secuenciales o en paralelo.'),
    (r'\bsed\b[^;|]*\s-i\b',
