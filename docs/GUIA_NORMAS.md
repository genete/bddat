...
| `potencia_instalada_mw` | numérico (MW) | `dato` · Proyecto | RD-ley 6/2022 art. 6 — potencia instalada total del proyecto en MW. Umbral eólica: ≤ 75 MW; fotovoltaica: ≤ 150 MW. No requerido para el art. 22 RDL 20/2022 (sin umbrales). **Deduplicación:** distinto de `tension_nominal_kv` (tensión) y de `modificacion_exceso_potencia_pct` (variación relativa en modificaciones). | pendiente de implementar |
