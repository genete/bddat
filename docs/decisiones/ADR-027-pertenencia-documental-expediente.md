...
- El borrado es **decisión del técnico, nunca automático**; la bitácora lo registra. El radar que se lo presenta es trabajo aparte (ADR-017 §5, "Mi trabajo" del técnico).
