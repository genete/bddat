...
**Hecho:** **#778** (PR #800) — plazos y suspensiones se miden con el mismo mecanismo (**ADR-041**). La emisión del certificado de cierre de la solicitud quedó fuera de alcance → **#801** (fase `RESOLUCIÓN`, no entra en la cola de abajo). Dato que no consta en el PR: ninguna de las 11 solicitudes tiene `documento_solicitud_id`, así que el plazo de la solicitud —y con él las suspensiones— no se ve en pantalla hasta que exista esa ancla; lo que se verificó en navegador fue el plazo de las tareas.
