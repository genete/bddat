...
ver `docs/referencia/DISEÑO_ANALISIS_SOLICITUD.md` §4/§7): #441/#408/#583/#581(diseño) en
...
- **#583 — CRUD admin de `requisitos_documentales`** (nuevo, 2026-07-03): interfaz de configuración para Supervisor, sin la cual poblar el catálogo exigiría migraciones a cada cambio normativo; mismo patrón que #170/#171. Backend+frontend; #408 no la necesita para su siembra mínima, pero es el habilitador de que esta no tenga que ser exhaustiva.
