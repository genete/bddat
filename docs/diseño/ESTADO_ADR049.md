...
- ~~#932 (N3) bloquea a N4~~ — cerrado: N4 tiene ya `tipo`, `fase_id` y el índice `(fase_id, tipo)`. Queda para N4 decidir si el PDF se guarda al emitir (ADR-049 §F) o se genera al vuelo como los certificados actuales.
