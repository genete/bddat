...
| `discurre_integra_subterranea_suelo_urbanizado` | boolean | `dato` · Proyecto | Ley 21/2013 Anexo I Grupo 3g / Anexo II Grupo 4b — la línea discurre íntegramente en subterráneo por suelo urbanizado; exime del Grupo 3g (EIA ordinaria) y de TODOS los criterios del Grupo 4b (EIA simplificada). **Deduplicación:** distinto de `es_linea_subterranea` (no captura "íntegramente") y de `es_suelo_urbano_o_urbanizable` ("urbanizable" ≠ "urbanizado" en sentido legal) | pendiente de implementar |
